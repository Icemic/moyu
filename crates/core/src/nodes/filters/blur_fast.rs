...
pub struct BlurFastFilterRenderer {
...
impl FilterRenderer for BlurFastFilterRenderer {
    ...
    fn execute(
        ...
        let FilterKind::BlurFast { radius, continuous } = filter else {
            return;
        };
