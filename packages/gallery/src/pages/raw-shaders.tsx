...
export function RawShadersPage() {
  ...
  return (
    <container>
      <Panel title="控制台" width={1504} height={200} x={0} y={0} zIndex={2}>
        <hbox x={20} y={56} gap={24} alignItems="center" zIndex={2}>
          <Select
            value={preset.title}
        ...
        <hbox x={20} y={124} gap={20} alignItems="center">
          <Button
      ...
      <Panel title="渲染结果" width={1504} height={680} x={0} y={232}>
        <shader
          ref={shaderRef}
          x={202}
          y={30}
        ...
        >
          <shader-slot channel={0}>
            <container>
              ...
              <text text="参数槽 · 通道采样 · builtins.time" fontSize={30} fillColor={ITEM_COLORS[1]} x={120} y={470} />
            </container>
          </shader-slot>
        </shader>
      </Panel>
