...
function ButtonPanel() {
  ...
  return (
    <Panel title="Button 按钮" width={600} height={440} note="点击计数、禁用态与文本对齐方式。">
      <vbox x={20} y={60} gap={16}>
...
function CheckboxPanel() {
  ...
  return (
    <Panel title="Checkbox 勾选框" width={420} height={440} note="受控与非受控两种用法。">
...
function SliderPanel() {
  ...
  return (
    <Panel title="Slider 滑块" width={420} height={440} note="轨道宽度可随面板收窄。">
      <vbox x={20} y={60} gap={24}>
...
function SelectPanel() {
  ...
  return (
    <Panel title="Select 下拉选择" width={728} height={440} note="下拉列表展开时会覆盖下方内容（zIndex）。">
      <container x={20} y={60}>
...
function ScrollViewPanel() {
  const scroll = useScrollView({ viewportHeight: 300 });

  return (
    <Panel title="ScrollView 滚动视图" width={744} height={440} note="滚轮或拖拽滚动。">
      <ScrollView
        width={700}
        height={300}
        controller={scroll}
