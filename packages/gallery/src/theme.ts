...
// NOTE: SelectListProps / SliderTrackProps / SliderThumbProps extend plain
// SpriteProps, which has no `tint` (tint lives in NodeProps and does not
// cascade). These three assets are therefore pre-colored by the generator.
